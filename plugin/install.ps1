...
$strings = @{
    "pt-BR" = @{
        ...
        SteamToolsCommand     = "Comando a ser executado: irm https://luatoolsplugin.vercel.app/cloudredirect.ps1 | iex"
...
if (`$lang -eq "pt-BR") {
    ...
    `$steamText = @{
        ...
        Warning = "WARNING: This command might be blocked by some antivirus. Make sure you trust the source (luatools)."
